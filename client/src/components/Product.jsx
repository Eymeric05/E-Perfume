  ...
  return (
    ...
    >
      <Link
        ...
        itemProp="url"
      >
        <figure className="relative aspect-square bg-gradient-to-br from-luxe-cream dark:from-luxe-charcoal to-luxe-warm-white dark:to-luxe-charcoal overflow-hidden">
          ...
          <figcaption className="sr-only">{product.name || 'Product'}</figcaption>
        </figure>
        ...
        <div className="p-5 bg-luxe-warm-white dark:bg-luxe-charcoal">
          {product.brand && (
            ...
            >
              ...
              <p className="font-sans text-xs text-luxe-charcoal/60 dark:text-luxe-cream/70 uppercase tracking-widest font-medium group-hover:text-luxe-gold transition-colors duration-200" itemProp="brand">
                {product.brand}
              </p>
            </Link>
          )}
          <h3 className="font-serif text-lg font-normal text-luxe-black dark:text-luxe-cream mb-3 hover:text-luxe-gold transition-colors duration-200 line-clamp-2 leading-tight" itemProp="name">
