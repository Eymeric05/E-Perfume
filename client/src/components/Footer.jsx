          ...
          <div className="mt-6 pt-6 border-t border-luxe-cream/10">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center justify-center gap-3 flex-wrap">
                {/* Stripe Logo */}
                <div className="bg-white rounded-lg px-4 py-2.5 flex items-center justify-center h-10 shadow-sm">
                  <img 
                ...
                <div className="bg-white rounded-lg px-4 py-2.5 flex items-center justify-center h-10 shadow-sm">
                  <img 
                    src="/images/footer/paypal-wordmark.svg" 
                    alt="PayPal" 
                    className="h-6 w-auto"
                  />
                </div>
                ...
                <div className="bg-white rounded-lg px-4 py-2.5 flex items-center justify-center h-10 shadow-sm">
                  <img 
                    src="/images/footer/Visa Inc._idDUM8TcN7_0.svg" 
                    alt="Visa" 
                    className="h-6 w-auto"
                  />
                </div>
                ...
                <div className="bg-white rounded-lg px-4 py-2.5 flex items-center justify-center h-10 shadow-sm">
                  <img 
                    src="/images/footer/Mastercard_Symbol_0.svg" 
                    alt="Mastercard" 
                    className="h-6 w-auto"
                  />
                </div>
